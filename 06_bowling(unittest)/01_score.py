# Консольная утилита, взаимодействующая с модулем bowling
# Принимает очки в игре боулинг и парсит их. Правила такие:
...
import argparse
from bowling import ScoreGetter

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('result', type=str, help='type in game result')
    args = parser.parse_args()
    x = ScoreGetter(res=args.result)
    print(x.run())